...
[Source PDF](rules.pdf) · [Map reference](south-korea-map.png)
...
u Each player also takes a set of 3 different Express Train cards <sub>u</sub> (+1, +2, and +3) and places them face up in front of them.
...
u The Train Car must be placed on the Line matching the color of the Route they just claimed. When claiming a gray Route, <sub>u</sub> a player can place their Train Car on any color Line.
